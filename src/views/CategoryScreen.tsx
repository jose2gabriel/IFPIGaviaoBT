// ============================================================================
// VIEW — Tela de Categoria: Listagem de Itens por Categoria selecionada
// Componente puramente de apresentação: busca de dados, estado de
// carregamento e formatação vêm do useCategoryViewModel.
// ============================================================================
...
export default function CategoryScreen() {
  ...
  const { carregando, produtos, nomeCategoria, formatarPreco } =
    useCategoryViewModel(categoriaId);
